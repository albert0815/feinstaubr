...
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.3', 'CLOUDY', 'bew�lkt');
...
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.9', 'RAIN', 'kr�ftiger Regen');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.10', 'HAIL', 'gefrierender Regen');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.11', 'HAIL', 'kr�ftiger gefrierender Regen');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.12', 'SLEET', 'Schneeregen');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.13', 'SLEET', 'kr�ftiger Schneeregen');
...
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.16', 'SNOW', 'kr�ftiger Schneefall');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.17', 'HAIL', 'Eisk�rner');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.18', 'SHOWER', 'Regenschauer');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.19', 'SHOWER', 'kr�ftiger Regenschauer');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.20', 'SLEET', 'Schneeregenschauer');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.21', 'SLEET', 'kr�ftiger Schneeregenschauer');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.22', 'SNOW', 'Schneeschauer');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.23', 'SNOW', 'kr�ftiger Schneeregenschauer');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.24', 'SLEET', 'Graupelschauer');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.25', 'SLEET', 'kr�ftiger Graupelschauer');
...
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.28', 'THUNDERSTORM', 'kr�ftiges Gewitter');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.29', 'THUNDERSTORM', 'Gewitter mit Hagel');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.30', 'THUNDERSTORM', 'kr�ftiges Gewitter mit Hagel');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'dwd', 'weather.31', 'STORM', 'B�en');
...
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'openweather', 'weather.501', 'RAIN', 'm��iger Regen');
...
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'openweather', 'weather.771', 'STORM', 'B�en');
...
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'openweather', 'weather.802', 'CLOUDY', 'aufgelockerte Bew�lkung');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'openweather', 'weather.803', 'CLOUDY', 'aufgelockerte Bew�lkung');
insert into FeinstaubrConfiguration values (nextval('hibernate_sequence'), 'openweather', 'weather.804', 'COVERED', 'bew�lkt');
...
-- 1.2
alter table sensorlocation add column height int4 null;
update sensorlocation set height = 505;
alter table sensorlocation alter column height drop default;
